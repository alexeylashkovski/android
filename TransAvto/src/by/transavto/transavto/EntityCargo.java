...
public class EntityCargo {
	...
	protected String cargo_type_txt = "";

	protected String cargo_length = "0.00";
	protected String cargo_width = "0.00";
	protected String cargo_height = "0.00";
	...
	public EntityCargo(JSONObject data) {
		...
		try {setCargoType(data.getString("cargo_type"));
		} catch (Exception e) {}
		try {setCargoTypeTxt(data.getString("cargo_type_txt"));
		} catch (Exception e) {}
		...
		try {setCargoLength(data.getString("cargo_length"));
		} catch (Exception e) {}
		try {setCargoWidth(data.getString("cargo_width"));
		} catch (Exception e) {}
		try {setCargoHeight(data.getString("cargo_height"));
		} catch (Exception e) {}
	...
	public void setCargoType(String vl){
		this.cargo_type = vl.trim().equalsIgnoreCase("null")?"":vl.trim();
	}
	public String getCargoType(){
		return this.cargo_type;
	}
	public void setCargoTypeTxt(String vl){
		this.cargo_type_txt = vl.trim().equalsIgnoreCase("null")?"":vl.trim();
	}
	public String getCargoTypeTxt(){
		return this.cargo_type_txt;
	}
	public String getFullCargoType(){
		if (getCargoTypeTxt().length()>0) return getCargoTypeTxt();
		else return getCargoType();
	}
	...
	public void setCargoLength(String vl){
		try {
			Float.parseFloat(vl);
			this.cargo_length = vl;
		}
		catch (Exception e) {
			this.cargo_length = "0.00";
		}
	}
	public String getCargoLength() {
		return this.cargo_length;
	}
	public void setCargoWidth(String vl){
		try {
			Float.parseFloat(vl);
			this.cargo_width = vl;
		}
		catch (Exception e) {
			this.cargo_width = "0.00";
		}
	}
	public String getCargoWidth() {
		return this.cargo_width;
	}
	public void setCargoHeight(String vl){
		try {
			Float.parseFloat(vl);
			this.cargo_height = vl;
		}
		catch (Exception e) {
			this.cargo_height = "0.00";
		}
	}
